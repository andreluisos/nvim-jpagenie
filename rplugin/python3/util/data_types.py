...
EnumType = Literal["ORDINAL", "STRING"]
IdGeneration = Literal["none", "auto", "identity", "sequence"]
IdGenerationType = Literal["none", "orm_provided", "entity_exclusive_generation"]
EntityType = Literal["entity", "embeddable", "mapped_superclass"]
